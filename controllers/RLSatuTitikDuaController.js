...
//  console.log(req.body.data[0].bor)
console.log("sini");
...
console.log(req.body);
  ...
  try {
      ...
      //         user_id: req.user.id,
      //         tahun: req.body.tahun,  
      //         bor: req.body.data[0].bor, 
      //         los: req.body.data[0].los,
      //         bto: req.body.data[0].bto,
      //         toi: req.body.data[0].toi,
      //         ndr: req.body.data[0].ndr, 
      //         gdr: req.body.data[0].gdr, 
      //         rata_kunjungan: req.body.data[0].rataKunjungan, 
      //     }
      // })
      const dataDetail = {
        "rs_id": req.user.rsId,
      ...
      // const resultInsertDetail = await rlSatuTitikDuaDetail.bulkCreate(dataDetail, { 
      //     transaction, 
      //     updateOnDuplicate:['bor','los','bto','toi','ndr','gdr','rata_kunjungan']
      // })
      // console.log(resultInsertDetail)
