...
export const updateDataRLEmpatASebab = async (req, res) => {
  ...
  try {
    ...
    const dataUpdate = {
      ...
      jmlh_pas_hidup_mati_umur_sex_6_28hr_l: req.body.par14thL,
      jmlh_pas_hidup_mati_umur_sex_6_28hr_p: req.body.par14thP,
      jmlh_pas_hidup_mati_umur_sex_28hr_1th_l: req.body.par28hr1thL,
      jmlh_pas_hidup_mati_umur_sex_28hr_1th_p: req.body.par28hr1thP,
      jmlh_pas_hidup_mati_umur_sex_1_4th_l: req.body.par28hrL,
      jmlh_pas_hidup_mati_umur_sex_1_4th_p: req.body.par28hrP,
